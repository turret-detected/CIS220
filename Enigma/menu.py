...
def welcome_menu():
	...
	print("                                                                               ")
	print("                                                                               ")
	print("                    Input 'I' to access the instructions                       ")
	print("                                                                               ")
	print("                                                                               ")
	print("                                                                               ")
	print("                                                                               ")
...
def instruction_menu():
	...
	print("                                Instructions                                   ")
	print("                                                                               ")
	print("     Use the list of commands to use the various functions of the Engima       ")
	print("                                                                               ")
	print("                                                                               ")
	print("                Command List:                                                  ")
	...
	print("                I: View these instructions again                               ")
	print("                Q: Quit                                                        ")
	print("                                                                               ")
	print("                                                                               ")
